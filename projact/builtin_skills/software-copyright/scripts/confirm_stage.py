...
def main() -> None:
    ...
    parser.add_argument('--stage', required=True, choices=['environment', 'project', 'business', 'code-selection', 'screenshot-method', 'application-fields', 'markdown'])
    parser.add_argument('--note', default='用户已确认')
    parser.add_argument('--method', choices=['chrome-devtools', 'computer-use', 'user-supplied', 'skip'], help='Screenshot capture method when --stage screenshot-method')
