...
def extract_video_id(url_or_id: str) -> str:
    ...
    patterns = ['(?:v=|youtu\\.be/|shorts/|embed/|live/)([a-zA-Z0-9_-]{11})', '^([a-zA-Z0-9_-]{11})$']
...
def main():
    ...
    if args.text_only:
        ...
        return
    result = {'video_id': video_id, 'segment_count': len(segments), 'duration': format_timestamp(segments[-1]['start'] + segments[-1]['duration']) if segments else '0:00', 'full_text': full_text}
    if args.timestamps:
